...
export const REPORT_TYPES = [
  {
    id: 'income',
    title: 'Доход',
    help: 'Сколько парк заработал за ночи в этих датах: уже прожитые и ещё впереди. Депозит не входит — его обычно возвращают. Уборка в сумме, только если в карточке квартиры стоит «гость платит».',
  },
  {
    id: 'payments',
    title: 'Платежи',
    help: 'Кто из гостей сколько должен и что уже отмечено оплаченным. Не путать с «Доходом»: там ночи, здесь долг по броням. Отмены в списке есть, оплата по ним — ноль.',
  },
  {
    id: 'by_property',
    title: 'Доход по квартирам',
    help: 'Тот же доход, но по каждой квартире. Сразу видно, кто кормит парк, а кто стоит пустой.',
  },
  {
    id: 'kpi',
    title: 'Доход + ADR + загрузка',
    help: 'Три цифры за период. Загрузка — какая доля ночей занята. ADR — средний чек за проданную ночь. RevPAR — сколько в среднем приносит одна ночь фонда, даже пустая.',
  },
  {
    id: 'pickup',
    title: 'Pick up',
    help: 'Сколько новых броней завели в эти дни. Смотрит на дату создания брони, не на заезд. Показывает, идут ли продажи, а не насколько забит календарь.',
  },
  {
    id: 'history',
    title: 'История по месяцам',
    help: 'Загрузка, средний чек и деньги — столбик за каждым месяцем. Чтобы сравнить август с июлем.',
  },
  {
    id: 'rooms',
    title: 'Загрузка по квартирам',
    help: 'Какая квартира сколько ночей продала из всех дней периода. Кто продаёт, кто простаивает. Закрытые блоки пока из фонда не вычитаются.',
  },
  {
    id: 'manager',
    title: 'Сводка менеджера',
    help: 'Картина на утро: что сегодня и сколько с 1-го числа месяца. Даты на странице почти не важны — всегда «сегодня» и накопительный итог.',
  },
  {
    id: 'window',
    title: 'Окно бронирования',
    help: 'За сколько дней до заезда гости бронируют: вчера на завтра или за две недели. Корзины 0–1, 2–3, 4–7, 8–14 и 15+ дней.',
  },
  {
    id: 'cancels',
    title: 'Аннуляции',
    help: 'Что отвалилось: отмены и гости, которые не заехали (до сих пор ждут подтверждения, а дата заезда уже прошла). Рядом — сколько живых броней завели за тот же период.',
  },
] as const;
